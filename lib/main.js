...
var ourSentence = 'I like ' + vanillaIceCream.flavor + '!';
console.log(ourSentence);
//Create another console.log that logs the statement "I like Vanilla" using a template string and "vanillaIceCream.flavor" as the value for vanilla